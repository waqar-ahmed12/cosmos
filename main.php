    ...
    <div class="logos">
        <div class="logoslide">
            <div class="T" onclick="openCategory('games')">
                <img src="templates/Template1.png"  >
                <p>GAMES</p>
            </div>
            <div class="T" onclick="openCategory('clothes')">
                <img src="templates/Template2.png"  >
                <p>CLOTHINGS</p>
            </div>
            <div class="T" onclick="openCategory('electronics')">
                <img src="templates/Template3.png"  >
                <p>ELECTRONICS</p>
            </div>
            <div class="T" onclick="openCategory('newBook')">
                <img src="templates/Template4.png"  >
                <p>BOOKS</p>
            </div>
            <div class="T" onclick="openCategory('food')">
                <img src="templates/Template5.png"  >
                <p>FOOD</p>
            </div>
            <div class="T" onclick="openCategory('film')">
                <img src="templates/Template6.png"  >
                <p>FILMS</p>
            </div>
        </div>    
